...
export function AdminGradeSearchPage() {
  ...
  async function save(kind: "correction" | "retake") {
    ...
    const payload = adminGradePayload(draft); if (!payload) { setError("出席率・平常点・課題点は整数で、理由を入力してください。"); return; }
