...
export const auditActions = [
  "academic_year_selected", "annual_rollover_applied", "csv_imported", "grades_exported",
...
export const auditActionLabels: Record<AuditAction, string> = {
  academic_year_selected: "年度を設定", annual_rollover_applied: "年度更新", csv_imported: "通常CSV取込", grades_exported: "成績CSV出力",
...
export const auditEntityTypeLabels: Record<AuditEntityType, string> = {
  academic_year: "年度", student: "学生", user: "アカウント", subject: "科目", subject_term: "科目・学期", grade: "成績", grade_export: "成績CSV", csv_import: "通常CSV",
};
